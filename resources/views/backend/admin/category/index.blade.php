           ...
           <hr>
            <div class="mb-2">
                <div class="row">
                    ...
                    <div class=" col-4 ">
                        <a href="{{route('admin.category.create')}}" type="button" class="btn btn-outline-info">
                            <i class="fas fa-plus"></i>
                            <span>ADD NEW CATEGOEY</span>
                        </a>
            ...
            <div class="">
                <table id="demo-foo-filtering" class="table toggle-circle mb-0 table-striped " data-page-size="7">
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            <span>
                            <a href="{{route('admin.category.show',$category->id)}}" type="button" class="btn btn-outline-primary mr-1">
                                <i class="fas fa-eye"></i>
                                </a>
                            </span>
                            <span>
                                <a href="{{route('admin.category.edit',$category->id)}}" type="button" class="btn btn-outline-success mr-1 ">
